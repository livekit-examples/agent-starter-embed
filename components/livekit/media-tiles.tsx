...
const classNames = {
  ...
  grid: [
    ...
    'grid-cols-[1fr_1fr] grid-rows-[90px_1fr_60px]',
  ],
  // Agent
  // chatOpen: true,
  // hasSecondTile: true
  ...
  // align: x-end y-end
  secondTileChatClosed: ['col-start-2 row-start-2 mr-3', 'place-content-end'],
};
...
export function MediaTiles({ chatOpen }: MediaTilesProps) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-10 m-1 overflow-hidden rounded-[24px]">
            ...
            <AnimatePresence mode="popLayout">
              ...
              {isAvatar && (
                ...
                <MotionAvatarTile
                  ...
                  videoTrack={agentVideoTrack}
                  className={cn(
                    chatOpen ? 'h-[90px] w-auto' : 'relative h-full w-full object-cover'
                  )}
                />
              )}
            </AnimatePresence>
