...
export const PopupView = ({
  ...
  return (
    <div ref={ref} inert={disabled} className="flex h-full w-full flex-col">
      <div className="relative flex h-full shrink-1 grow-1 flex-col p-2">
        <header className="relative m-0.25 flex justify-center">
          <motion.div
            initial={false}
            animate={{
            ...
            className="bg-bg3 flex items-center justify-center gap-2 rounded-full px-3 py-0.5"
          >
            <BarVisualizer
              barCount={5}
              trackRef={agentAudioTrack}
              options={{ minHeight: 5 }}
              className="flex h-7 w-auto items-center justify-center gap-0.5"
            >
              <span
                className={cn([
          ...
          {visibleControls.leave ? (
            <div className="absolute top-0 right-0">
              <Button size="sm" variant="destructive" onClick={onLeave} className="font-mono">
